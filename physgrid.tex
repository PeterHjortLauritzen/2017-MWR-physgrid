...
%\begin{figure*}[t]
\begin{center}
%\noindent\includegraphics[width=37pc,angle=0]{se_gll_cv_grid-eps-converted-to.pdf}\\
\noindent\includegraphics[width=15pc,angle=0]{figs/se_gll_cv_grid-eps-converted-to.pdf}\\
%\noindent\includegraphics[width=37pc,angle=0]{figs/se_gll_cv_grid-eps-converted-to.pdf}\\
\end{center}
