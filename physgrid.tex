...
%Similar to Figure~\ref{fig:omega-se-volumes}, but the state in conditionally sampled according to $ne30pg3$ control volume location within each element (1-9). Probability density distribution computed from one year of 6-hourly data +/- $10^\circ$ from the equator, and at all vertical levels. Through the use of the $ne30pg3$ physics grid, the state is now independent of in-element location.
...
\begin{figure}[t]
\noindent\includegraphics[width=19pc,angle=0]{figs/FHS-contours.pdf}\\
...
\begin{figure}[t]
\noindent\includegraphics[width=19pc,angle=0]{figs/FHS-transect.pdf}\\
