...
\item linear correlation preservation{\color{red}{, i.e. preserves linear stoichiometric relationships between two reactive species \citep[see][]{LT2011QJR}}}
\end{enumerate}
...
{\color{red}{Additionally, the magnitude of $\omega$ in CAM-SE-CSLAM is systematically smaller for more negative values (less than ~0.7 Pa/s), indicating that the state is ...Is the physics grid taming the extremes, i.e., the state is not the same between the two models?}
