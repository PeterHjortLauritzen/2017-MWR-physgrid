...
\item linear correlation preservation{\color{red}{, i.e. preserves linear stoichiometric relationships between two reactive species}}
\end{enumerate}
