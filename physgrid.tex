...
The CAM aqua-planet reference configuration (Neale and Hoskins 2001; Medeiros et al 2016) consists of an ocean covered planet in a perpetual equinox, with fixed, zonally symmetric SST temperatures that share a resemblance of present day Earth. The aqua-planet configuration illustrates the grid imprinting of
