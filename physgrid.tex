...
The default control volume grid used to comptue fluxes between components of the Community Earth System Model. In the physics grid configuration, the native model topography is defined on the physics grid, 

The default grid used to comptue fluxes between components of the Community Earth System Model, is highly anisotropic
The finite-volume physics grid also serves as a convenient choice for the computing fluxes between components of the Community Earth System Model. The topogaphy (or surface geopotential) 
